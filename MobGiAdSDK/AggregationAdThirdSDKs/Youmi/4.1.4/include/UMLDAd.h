 ...
 *
 */ 
+(void)videoPlay:(UIViewController *)viewController videoPlayFinishCallBackBlock:(void(^)(BOOL isFinishPlay))block videoPlayConfigCallBackBlock:(void(^)(BOOL isLegal))configBlock videoPlayStartBackBlock:(void(^)(BOOL isStartPlay))startblock videoPlayClickBackBlock:(void(^)(BOOL isClick))clickblock;
 ...
 * videoPlayConfigCallBackBlock will be called after YouMi server confirm. If parameter isLegal is setted to yes, income comes for you.
 */
+(void)videoPlay:(UIViewController *)viewController videoSuperView:(UIView *)superView videoPlayerFrame:(CGRect)VideoPlayerFrame videoPlayFinishCallBackBlock:(void(^)(BOOL isFinish))block videoPlayConfigCallBackBlock:(void(^)(BOOL isLegal))configBlock videoPlayStartBackBlock:(void(^)(BOOL isStartPlay))startblock videoPlayClickBackBlock:(void(^)(BOOL isClick))clickblock;
 ...
 *
 */
+(void)videoSpotPlay:(UIViewController *)viewController videoSuperView:(UIView *)superView videoPlayFinishCallBackBlock:(void(^)(BOOL isFinish))block videoPlayConfigCallBackBlock:(void(^)(BOOL isLegal))configBlock videoPlayStartBackBlock:(void(^)(BOOL isStartPlay))startblock videoPlayClickBackBlock:(void(^)(BOOL isClick))clickblock;
